...
|---|---|---|
| [AFL Sports Analysis](./AFL%20Sports%20Analysis) | Statistical analysis of AFL team/match performance data. | R |
| [Heart Disease Prediction Analysis](./Heart%20Disease%20Prediction%20Analysis) | Predictive statistical modelling of heart disease risk factors. | R |
| [Car Fuel efficiency Analysis](./Car%20Fuel%20efficiency%20Analysis) | Regression analysis of vehicle fuel efficiency data (2017–2020). | R |
| [Dog bites Analysis](./Dog%20bites%20Analysis) | Statistical investigation of dog bite incidence, including a full-moon correlation study. | R |
| [Dice Probability Analysis](./Dice%20Probability%20Analysis) | Applied probability analysis of dice-rolling outcomes. | R |
